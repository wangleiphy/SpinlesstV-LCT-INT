...
Ktrial_left(buildKtrial(lattice, "L")), // to generate the trial wave function  
Ktrial_right(buildKtrial(lattice, "R")),  
gf(K_, Ktrial_left, Ktrial_right, beta/boost::lexical_cast<double>(itime_max), itime_max, nblock, blocksize,parms["WRAP_REFRESH_PERIOD"]), 
